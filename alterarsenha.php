...
<div class="w3-top">
  ...
  <div id="navDemo" class="w3-hide w3-hide-large w3-hide-medium">
	...
	<form action="conns/alterpassword.php" method="post"> 
		...
		<center>
			<?php
			IF ($perfil=='ADMRET'){
				echo("<input type='text' placeholder='Login (CS)'  name='loginrede' size='40' style='width: 170px;'><BR> <br>");
			} else {
				echo("<input type='password' placeholder='Senha Atual'  name='senhaatual' size='40' style='width: 170px;'><BR> <br>");
			}
			?>
