...
<title>Solicitação de Folgas</title>
<meta charset='UTF-8'>
...
<div class="w3-top">
  <ul class="w3-navbar dark-blue w3-card-2 w3-left-align w3-large">
    ...
    <li class="w3-hide-small"><a href="inserir.php" class="w3-padding-large w3-hover-white">Solicitar Folga</a></li>
    <li class="w3-hide-small"><a href="consultar.php" class="w3-padding-large w3-hover-white">Consultar Folga</a></li>
    
    <?php
		IF ($perfil=='ADMRET'){
			echo("<li class='w3-hide-small'><a href='validar.php' class='w3-padding-large w3-hover-white'>Validar Folga</a></li>");
			echo("<li class='w3-hide-small'><a href='reset_senha.php' class='w3-padding-large w3-hover-white'>Resetar Senha</a></li>");
		}
	 ?>
	 <li><a class="w3-padding-large" href="ajustes.php">Solicitar Ajuste</a></li>
     <li><a class="w3-padding-large" href="consultarajustes.php">Consultar Ajuste</a></li>
	 <?php
		IF ($perfil=='ADMRET'){
			echo("<li class='w3-hide-small'><a href='validar.php' class='w3-padding-large w3-hover-white'>Validar Ajuste</a></li>");
			echo("<li class='w3-hide-small'><a href='reset_senha.php' class='w3-padding-large w3-hover-white'>Resetar Senha</a></li>");
		}
	 ?>
